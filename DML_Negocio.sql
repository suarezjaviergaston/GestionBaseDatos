...
INSERT INTO `negocio`.`facturas` (`letra`, `numero`, `fecha`, `monto`, `forma_de_pago`, `id_cliente`) VALUES ('B', '1', '23/03/2022', '2250', 'EFECTIVO', '1');
INSERT INTO `negocio`.`facturas` (`letra`, `numero`, `fecha`, `monto`, `forma_de_pago`, `id_cliente`) VALUES ('A', '1', '24/03/2022', '2420', 'CHEQUE', '2');
INSERT INTO `negocio`.`facturas` (`letra`, `numero`, `fecha`, `monto`, `forma_de_pago`, `id_cliente`) VALUES ('B', '2', '25/03/2022', '1150', 'TARJETA', '3');

/* carga de detalle */

INSERT INTO `negocio`.`detalles` (`id_factura`, `id_articulos`, `cantidad`, `precio_unitario`) VALUES ('1', '1', '1', '500');
INSERT INTO `negocio`.`detalles` (`id_factura`, `id_articulos`, `cantidad`, `precio_unitario`) VALUES ('1', '4', '1.5', '1350');
INSERT INTO `negocio`.`detalles` (`id_factura`, `id_articulos`, `cantidad`, `precio_unitario`) VALUES ('1', '3', '2', '400');
INSERT INTO `negocio`.`detalles` (`id_factura`, `id_articulos`, `cantidad`, `precio_unitario`) VALUES ('2', '2', '1', '150');
INSERT INTO `negocio`.`detalles` (`id_factura`, `id_articulos`, `cantidad`, `precio_unitario`) VALUES ('2', '3', '1', '200');
INSERT INTO `negocio`.`detalles` (`id_factura`, `id_articulos`, `cantidad`, `precio_unitario`) VALUES ('2', '4', '2.3', '2070');
INSERT INTO `negocio`.`detalles` (`id_factura`, `id_articulos`, `cantidad`, `precio_unitario`) VALUES ('3', '5', '1', '1150');
